  ...
  <nav class="main-nav animated bounceInDown">
        <ul class="main-nav_list">
          ...
          <li class="wed-item"><a class="wed-link" href="../../wedding.php">Свадебное оформление</a>
            <ul class="wed-services">
              <li><a href="bride-bouq.php">Букет невесты</a></li>
              <li><a href="reg-zone.php">Зона регистрации</a></li>
              <li><a href="main-table.php">Стол молодых</a></li>
              <li><a href="guest-table.php">Гостевые столы</a></li>
              <li><a href="flower-acc.php">Цветочные аксессуары</a></li>
              <li><a href="gift-bouq.php">Подарочный букет</a></li>
            </ul>
          </li>
      ...
      <nav class="mobile-nav ">
            <div class="top-panel">
              ...
              <a href="tel:+79082516861" class="call-us ">
              </a>
              ...
              <ul class="mob-menu">
                ...
                <ul class="mob-wed-services">
                    <li><a href="bride-bouq.php">Букет невесты и бутоньерка</a>
                    <li><a href="reg-zone.php">Зона регистрации</a>
                    <li><a href="main-table.php">Стол молодых</a></li>
                    <li><a href="guest-table.php">Гостевые столы</a>
                    <li><a href="flower-acc.php">Цветочные аксессуары</a>
                    <li><a href="gift-bouq.php">Подарочный букет</a>
                </ul>
                </li>
